...
Usage:
- Tuner module to get the best hyperparameters
"""
...
def get_tuner_model(hyperparameters):
    ...
    deep = layers.Dense(dense_units, activation=tf.nn.relu)(concatenate)
...
def tuner_fn(fn_args):
    ...
    tuner = kt.RandomSearch(
        ...
        # llow_new_entries=False,
        objective="val_binary_accuracy",
        directory=fn_args.working_dir,
        project_name="bank_market_kt",
        max_trials=20,
    )
